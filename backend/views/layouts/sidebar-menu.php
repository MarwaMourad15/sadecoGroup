        ...
        'items' => [
             ...
             [
                ...
                'items' => [
                    ...
                    [
                        ...
                        'url' => ['/partner'],
                        'icon' => 'fa fa-book',
                        'active' => Yii::$app->request->scriptUrl === Yii::$app->params['siteLink'].'backend/web/'.'partner'
                    ],
                ],
            ],
            /*[
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        'label' => Yii::t('app', 'Calibration Brief'),
                        'url' => ['/pages/update/7'],
                        'icon' => 'fa fa-users',
                        'active' => Yii::$app->request->scriptUrl === Yii::$app->params['siteLink'].'backend/web/'.'/pages/update/7'
                    ],
                ],
            ],
            ...
            [
                ...
                'url' => ['/pages/update/8'],
                'icon' => 'fa fa-users',
                'active' => Yii::$app->request->scriptUrl === Yii::$app->params['siteLink'].'backend/web/'.'pages/update/8'
            ],
            /*[
...
//            ],
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        'label' => Yii::t('app', 'User Feedback'),
                        'url' => ['/user-feedback/index'],
                        'icon' => 'fa fa-briefcase',
                        'active' => Yii::$app->request->scriptUrl === Yii::$app->params['siteLink'].'backend/web/'.'user-feedback/index'
                        //'visible' => (Yii::$app->user->identity->username == 'admin'),
                    ],
                ],
            ],
            ...
            [
                'label' => Yii::t('app', 'Related Section'),
                'url' => ['/related-section/index'],
                'icon' => 'fa fa-bullhorn',
                'active' => Yii::$app->request->scriptUrl === Yii::$app->params['siteLink'].'backend/web/'.'related-section/index'
            ],
            [
