...
<div class="user-form">
    ...
    <?= $form->field($model, 'other_account_name')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'account_website')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'title')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'mailing_country_id')->textInput() ?>
